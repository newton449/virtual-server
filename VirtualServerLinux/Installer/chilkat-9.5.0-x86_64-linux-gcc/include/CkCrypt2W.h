...
class CkCrypt2W  : public CkWideCharBase
{
	...
	// Returns the last certificate used when decrypting data or verifying a signature.
	// This is only valid when public-key encryption is used, and does not apply to
	// symmetric algorithms such as Rijndael, Blowfish, or Twofish.
	...
	// This method can be called after a digital signature is verified to retrieve the
	// certificate(s) used for signing. The 1st certificate is at index 0. The
	// NumSignerCerts property contains the total number of signing certificates.
	// (Typically, a single certificate is used in creating a digital signature.)
	// The caller is responsible for deleting the object returned by this method.
	...
	// values of 128, 160, 192, 224, or 256.
	// 
	bool HashFile(const wchar_t *filename, CkByteData &outData);
