...
class CkCertW  : public CkWideCharBase
{
	...
	// for all other ASN.1 tags, such as "octets", it is base64.) For example,
	// exporting the current chilkatsoft.com SSL server certificate results in the XML
	// shown at the URL below:
