...
${OBJECTDIR}/_ext/1278082062/HttpServletsImpl.o: ../../VirtualServerWindows/Installer/HttpServletsImpl.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1278082062/HttpServletsImpl.o ../../VirtualServerWindows/Installer/HttpServletsImpl.cpp

${OBJECTDIR}/_ext/1278082062/ModuleObjectFactoryImpl.o: ../../VirtualServerWindows/Installer/ModuleObjectFactoryImpl.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1278082062
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1278082062/ModuleObjectFactoryImpl.o ../../VirtualServerWindows/Installer/ModuleObjectFactoryImpl.cpp

${OBJECTDIR}/_ext/1278082062/ServletFactoryImpl.o: ../../VirtualServerWindows/Installer/ServletFactoryImpl.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1278082062
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1278082062/ServletFactoryImpl.o ../../VirtualServerWindows/Installer/ServletFactoryImpl.cpp
...
${OBJECTDIR}/_ext/147134308/FileSystem_Linux.o: ../MainProgram/FileSystem_Linux.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/147134308/FileSystem_Linux.o ../MainProgram/FileSystem_Linux.cpp
