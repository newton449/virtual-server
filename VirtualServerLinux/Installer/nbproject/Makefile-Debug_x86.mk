...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ../../TestTarget/Installer/Installer_x86.so

../../TestTarget/Installer/Installer_x86.so: ${OBJECTFILES}
	${MKDIR} -p ../../TestTarget/Installer
	${LINK.cc} -o ../../TestTarget/Installer/Installer_x86.so ${OBJECTFILES} ${LDLIBSOPTIONS} -shared -fPIC
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ../../TestTarget/Installer/Installer_x86.so
