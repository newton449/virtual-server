...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ../../FinalTarget/MainProgram/MainProgram_Linux_x64

../../FinalTarget/MainProgram/MainProgram_Linux_x64: ${OBJECTFILES}
	${MKDIR} -p ../../FinalTarget/MainProgram
	${LINK.cc} -o ../../FinalTarget/MainProgram/MainProgram_Linux_x64 ${OBJECTFILES} ${LDLIBSOPTIONS}
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ../../FinalTarget/MainProgram/MainProgram_Linux_x64
