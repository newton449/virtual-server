...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ../../FinalTarget/Home/Home_x86.so

../../FinalTarget/Home/Home_x86.so: ${OBJECTFILES}
	${MKDIR} -p ../../FinalTarget/Home
	${LINK.cc} -o ../../FinalTarget/Home/Home_x86.so ${OBJECTFILES} ${LDLIBSOPTIONS} -shared -fPIC
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ../../FinalTarget/Home/Home_x86.so
