...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ../../TestTarget/Home/Home_x64.so

../../TestTarget/Home/Home_x64.so: ${OBJECTFILES}
	${MKDIR} -p ../../TestTarget/Home
	${LINK.cc} -o ../../TestTarget/Home/Home_x64.so ${OBJECTFILES} ${LDLIBSOPTIONS} -shared -fPIC
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ../../TestTarget/Home/Home_x64.so
