...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ../../TestTarget/Home/Home_x86.so

../../TestTarget/Home/Home_x86.so: ${OBJECTFILES}
	${MKDIR} -p ../../TestTarget/Home
	${LINK.cc} -o ../../TestTarget/Home/Home_x86.so ${OBJECTFILES} ${LDLIBSOPTIONS} -shared -fPIC
...
${OBJECTDIR}/_ext/646640793/HttpServletsImpl.o: ../../VirtualServerWindows/Home/HttpServletsImpl.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/646640793/HttpServletsImpl.o ../../VirtualServerWindows/Home/HttpServletsImpl.cpp

${OBJECTDIR}/_ext/646640793/ModuleObjectFactoryImpl.o: ../../VirtualServerWindows/Home/ModuleObjectFactoryImpl.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/646640793
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/646640793/ModuleObjectFactoryImpl.o ../../VirtualServerWindows/Home/ModuleObjectFactoryImpl.cpp

${OBJECTDIR}/_ext/646640793/ServletFactoryImpl.o: ../../VirtualServerWindows/Home/ServletFactoryImpl.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/646640793
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/646640793/ServletFactoryImpl.o ../../VirtualServerWindows/Home/ServletFactoryImpl.cpp
...
${OBJECTDIR}/HttpServletsImpl_Linux.o: HttpServletsImpl_Linux.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HttpServletsImpl_Linux.o HttpServletsImpl_Linux.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ../../TestTarget/Home/Home_x86.so
