...
class CkEmail  : public CkMultiByteBase
{
	...
	// 
	// If this method is not yet available in your version of the Chilkat Email object,
	// you may also call GetHeaderField("ckx-imap-uid") to fetch the UID as a string,
