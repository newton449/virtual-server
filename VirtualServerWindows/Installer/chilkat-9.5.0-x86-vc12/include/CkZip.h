...
class CkZip  : public CkMultiByteBase
{
	...
	// = twofish, 3 = rijndael (AES), 4 = WinZip compatible AES. When a Zip is
	// encrypted, the directory will still be readable by programs such as WinZip, but
	// the contents, if unzipped, will be encrypted. For modes 1,2, and 3, only
	// applications using Chilkat Zip can decrypt and unzip Zip files created by
	// Chilkat Zip. However, setting this property = 4 produces a WinZip compatible AES
	// encrypted .zip file.
	// 
	// Note:Chilkat implemented strong-encryption prior to WinZip. When modes 1, 2, and
	// 3 were originally implemented, WinZip AES encryption did not yet exist. When
	// WinZip introduced AES encryption, Chilkat added mode 4 to provide the ability to
	// create compatible AES-encrypted zips.
	// 
