...
class CkImap  : public CkMultiByteBase
{
	...
	// "\Flagged", "\Draft", and "\Answered". Custom flags can be anything, such as
	// "NonJunk", "$label1", "$MailFlagBit1", etc. .
	...
	// flags typically begin with a backslash character, such as "\Seen", "\Answered",
	// "\Flagged", "\Draft", and "\Answered". Custom flags can be anything, such as
	// "NonJunk", "$label1", "$MailFlagBit1", etc. .
	// 
