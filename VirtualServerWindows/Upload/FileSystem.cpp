...
{
  size_t pos = fileSpec.find_last_of(std::string("."));
    if(pos < 2)
      // no ext
      return "";
  if(pos < fileSpec.length())
...
int main(int argc, char* argv[])
{
  ...
  */
  ...
  {
    fn1 = "../FileSystem/FileSystem.h";
    fn2 = "../FileSystem/FileSystem.cpp";
  }
  FileInfo fi1(fn1);
  FileInfo fi2(fn2);
  ...
  files.push_back("../FileSystem/FileSystem.cpp");
  files.push_back("../Channel/Channel.h"); // file from project directory
